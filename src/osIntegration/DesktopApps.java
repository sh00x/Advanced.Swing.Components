...
import additionalResources.GBC;
...
/**
 * Pozwala użytkownikowi otwierać, edytować i drukować
 * wybrany plik, a także przeglądać podany URL lub
 * uruchamiać klienta poczty elektronicznej
 */
public class DesktopApps extends JFrame {
    ...
    public DesktopApps() {
        ...
        fileChooserButton.addActionListener(e -> {
            if (chooser.showOpenDialog(DesktopApps.this) == JFileChooser.APPROVE_OPTION)
        ...
        pack();
        setTitle("Desktop Apps - @sh00x.dev");
        setVisible(true);
    }
